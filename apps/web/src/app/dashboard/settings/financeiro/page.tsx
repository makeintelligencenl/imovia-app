...
export default function FinanceiroSettingsPage() {
  ...
  function handlePercImob(v: number) {
    setConfig((c) => ({ ...c, percImobiliaria: v, percCorretor: round2(c.percentualTotal - v) }))
  }

  function handlePercCorr(v: number) {
    setConfig((c) => ({ ...c, percCorretor: v, percImobiliaria: round2(c.percentualTotal - v) }))
  }
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-32">
              <input
                type="number" min={0} max={config.percentualTotal} step={0.1}
